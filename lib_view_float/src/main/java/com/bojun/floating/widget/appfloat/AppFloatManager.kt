...
import android.view.*
import com.bojun.floating.anim.AppFloatAnimatorManager
import com.bojun.floating.data.FloatConfig
import com.bojun.floating.enums.ShowPattern
import com.bojun.floating.interfaces.OnFloatTouchListener
import com.bojun.floating.utils.DisplayUtils
import com.bojun.floating.utils.Logger

/**
 * 系统浮窗的管理类，包括浮窗的创建、销毁、动画管理等
 */
